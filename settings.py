# Django settings for aaoquadrado project.
import os
import sys
...
ADMINS = (
    ('adriano', 'petrich@aaoquadrado.com'),
)
...
SECRET_KEY = '^kb$z!vsby$a1szek*8rymnc^^*1_3acvt039*a0sb(2v^&*7j'
